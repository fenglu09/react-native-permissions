...
const AndroidPermission = NativeModules.AndroidPermission;
...
class ReactNativePermissions {
  ...
  openSettings: () => Promise<*> = () => AndroidPermission.openSettings()

  //add by david 开启网络连接 start
  openNetWorkSettings: () => Promise<*> = () => AndroidPermission.openNetWorkSettings()
  //add by david 开启网络连接 end


  checkAndroidPermission = (permission: string): Promise<boolean> => {
    return AndroidPermission.check(permissionTypes[permission]);
  }
